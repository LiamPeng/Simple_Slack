...
VALUES
    ...
    (2, 1, 3, 2, '2026-01-29 09:00:00', 'accepted'),
    (3, 2, 4, 2, '2026-03-16 11:00:00', 'pending'),
    (4, 2, 1, 2, '2026-03-21 18:22:00', 'declined');
...
VALUES
    ...
    (5, 1, 'dm-alice-bob', 'direct', 1, '2026-02-06 10:00:00');
...
VALUES
    ...
    (2, 3, '2026-02-01 10:00:00'),

    (3, 1, '2026-02-04 14:00:00'),
    (3, 2, '2026-02-04 14:10:00'),

    (4, 2, '2026-03-16 15:00:00'),
    (4, 3, '2026-03-17 15:15:00'),
    (4, 5, '2026-03-26 20:00:00'),

    (5, 1, '2026-02-06 10:00:00'),
    (5, 2, '2026-02-06 10:00:00');

INSERT INTO ChannelInvitation
VALUES
    (1, 1, 4, 1, '2026-02-03 18:30:00', 'pending'),
    (2, 1, 3, 2, '2026-01-29 11:00:00', 'accepted'),
    (3, 3, 2, 1, '2026-02-04 13:30:00', 'accepted'),
    (4, 4, 5, 2, '2026-03-20 12:00:00', 'accepted'),
...
VALUES
    ...
    (7, 3, 2, 'Keep this private', '2026-02-05 14:10:00'),

    (8, 4, 2, 'Dynamic programming today', '2026-03-17 15:30:00'),
    (9, 4, 3, 'I love graphs', '2026-03-18 15:35:00'),

    (10, 5, 1, 'Hey Bob, are you free later?', '2026-02-06 10:05:00'),
    (11, 5, 2, 'Yes, let us talk after class.', '2026-02-06 10:06:00');